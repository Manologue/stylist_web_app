...
<div class="wrapper">
 ...
 <div class="content-page edit-service-page">
  <div class="content">
   <!-- Topbar Start -->
   ...
   <div class="container-fluid">
    ...
    <form class="form-category" method="POST" action="<?= DOC_ROOT ?>account/edit_service/<?= $identifier ?>" enctype="multipart/form-data">
